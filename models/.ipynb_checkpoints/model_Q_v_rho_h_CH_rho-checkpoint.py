...
def main():
    ...
    system.create_term("phi", [("Ident", None)], [-(rho_c-np.sqrt(a/(3*b))), 0, 0, 0, 0])
    # Define RhoEnd
    ...
    system.create_term("Hxx", [("rho", (np.power, 2)), ("Qxx", None)], [1, 0, 0, 0, 0])
    system.create_term("Hxx", [("rho", (np.power, 2)), ("S2", None), ("Qxx", None)], [-1, 0, 0, 0, 0])
    ...
    system.create_term("Hxy", [("rho", (np.power, 2)), ("Qxy", None)], [1, 0, 0, 0, 0])
    system.create_term("Hxy", [("rho", (np.power, 2)), ("S2", None), ("Qxy", None)], [-1, 0, 0, 0, 0])
