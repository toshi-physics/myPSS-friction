...
def main():
    ...
    system.create_term("rho", [("phi", None)], [a*D, 1, 0, 0, 0])
    system.create_term("rho", [("phi", (np.power, 3))], [-b*D, 1, 0, 0, 0])
    system.create_term("rho", [("phi", None)], [-d*D, 2, 0, 0, 0])
    system.create_term("rho", [("rho", None), ("rho_end", (np.power, -1)), ("rho_end_rho", None), ("rho_end_rho", (np.heaviside, 0))], [1, 0, 0, 0, 0])
