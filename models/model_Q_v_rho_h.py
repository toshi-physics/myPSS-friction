...
def main():
    ...
    system.create_field('phi', k_list, k_grids, dynamic=False)
    ...
    # Define rho minus one
    system.create_term("phi", [("rho", None)], [1, 0, 0, 0, 0])
    system.create_term("phi", [("Ident", None)], [-(1-np.sqrt(a/(3*b))), 0, 0, 0, 0])
    # Define Pressure
    ...
    system.create_term("rho", [("S2", None)], [D, 1, 0, 0, 0])
    system.create_term("rho", [("S2", (np.power, 2))], [-D, 1, 0, 0, 0])
    system.create_term("rho", [("iqxQxx", (np.power, 2))], [-D*K, 1, 0, 0, 0])
    system.create_term("rho", [("iqxQxy", (np.power, 2))], [-D*K, 1, 0, 0, 0])
    system.create_term("rho", [("iqyQxx", (np.power, 2))], [-D*K, 1, 0, 0, 0])
    system.create_term("rho", [("iqyQxy", (np.power, 2))], [-D*K, 1, 0, 0, 0])
    system.create_term("rho", [("phi", None)], [a, 1, 0, 0, 0])
    system.create_term("rho", [("phi", (np.power, 3))], [-b, 1, 0, 0, 0])
    system.create_term("rho", [("phi", None)], [-d, 2, 0, 0, 0])
    system.create_term("rho", [("rho", None), ("rho_end", (np.power, -1)), ("rho_end_rho", None)], [1, 0, 0, 0, 0])
